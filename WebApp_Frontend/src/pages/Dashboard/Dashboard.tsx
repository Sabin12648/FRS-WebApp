...
// //         </CardDataStats>
// //         <div className='place-content-end'><button
// //         onClick={openModal} 
// //         className="h-10 w-50 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">{"+ Add Applicant"}</button></div>
// //         </div>
...
//   const token = localStorage.getItem('access_token'); // Or use context if applicable

//   console.log("Token before opening modal:", token);
