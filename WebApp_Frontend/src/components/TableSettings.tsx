...
interface TableProps {
  rows: {
    id: number;   // Assuming id is of type number, adjust as per your data structure
    para: string; // Assuming para is of type string, adjust as per your data structure
    criterion: number; // Assuming criterion is of type number, adjust as per your data structure
    value: number | string; // Assuming value can be number or string, adjust as per your data structure
    type: number; // Assuming type is of type number, adjust as per your data structure
  }[];
